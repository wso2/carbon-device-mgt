...
public class DeviceManagementProviderServiceImpl implements DeviceManagementProviderService,
    ...
    public boolean disenrollDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            ...
            deviceDAO.updateDevice(device, tenantId);
            deviceDAO.clearLogs(device.getEnrolmentInfo().getId());
    ...
    public PaginationResult getAllDevices(PaginationRequest request) throws DeviceManagementException {
        ...
        //devices.stream().filter(d->d.getDeviceInfo().getDeviceModel()==request.getModel());
        /*if(!request.getModel().equalsIgnoreCase("all")) {
        	ListIterator<Device> itr=devices.listIterator();
        	while(itr.hasNext())
        		if(!itr.next().getProperties().get(5).getValue().equalsIgnoreCase(request.getModel()))
        			itr.remove();
    ...
    public Device getDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            ...
            device.setDeviceGroups(deviceDAO.getGroupsOfDevice(deviceId));
