...
CREATE TABLE IF NOT EXISTS `DM_DEVICE_TYPE` (
  ...
  `LAST_UPDATED_TIMESTAMP` TIMESTAMP AS CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`));
...
CREATE UNIQUE INDEX IF NOT EXISTS `uk_DM_DEVICE` ON `DM_DEVICE`(`NAME` ASC, `DEVICE_TYPE_ID` ASC, `DEVICE_IDENTIFICATION` ASC);
CREATE INDEX IF NOT EXISTS `fk_DM_DEVICE_DM_DEVICE_TYPE2` ON `DM_DEVICE` (`DEVICE_TYPE_ID` ASC);
...
CREATE INDEX IF NOT EXISTS  `fk_dm_device` ON `DM_DEVICE_APPLICATION_MAPPING`(`DEVICE_ID` ASC);
CREATE INDEX IF NOT EXISTS  `fk_dm_application` ON `DM_DEVICE_APPLICATION_MAPPING`(`APPLICATION_ID` ASC);
...
CREATE INDEX IF NOT EXISTS `FK_DM_DEVICE_DETAILS_DEVICE` ON `DM_DEVICE_DETAIL` (`DEVICE_ID` ASC);
...
CREATE UNIQUE INDEX IF NOT EXISTS  `uk_dm_device_enrolment` ON `DM_ENROLMENT`(`DEVICE_ID` ASC, `OWNER` ASC, `OWNERSHIP` ASC);
...
CREATE INDEX IF NOT EXISTS  `fk_DM_DEVICE_GROUP_MAP_DM_ENROLMENT2` ON `DM_ENROLEMENT_GROUP_MAP`(`ENROLMENT_ID` ASC);
CREATE INDEX IF NOT EXISTS  `fk_DM_DEVICE_GROUP_MAP_DM_GROUP2` ON `DM_ENROLEMENT_GROUP_MAP`(`GROUP_ID` ASC);
...
CREATE INDEX IF NOT EXISTS  `DM_DEVICE_INFO_DEVICE` ON `DM_DEVICE_INFO`(`DEVICE_ID` ASC);
...
CREATE TABLE IF NOT EXISTS `DM_OPERATION` (
  ...
  `CREATED_TIMESTAMP` TIMESTAMP AS CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`));
...
CREATE INDEX IF NOT EXISTS  `fk_dm_device_operation_mapping_device` ON `DM_ENROLMENT_OP_MAPPING`(`ENROLMENT_ID` ASC);
CREATE INDEX IF NOT EXISTS  `fk_dm_device_operation_mapping_operation` ON `DM_ENROLMENT_OP_MAPPING`(`OPERATION_ID` ASC);
...
CREATE INDEX IF NOT EXISTS  `fk_dm_device_operation_response_enrollment` ON `DM_DEVICE_OPERATION_RESPONSE`(`ENROLMENT_ID` ASC);
CREATE INDEX IF NOT EXISTS  `fk_dm_device_operation_response_operation` ON `DM_DEVICE_OPERATION_RESPONSE`(`OPERATION_ID` ASC);
CREATE INDEX IF NOT EXISTS  `fk_dm_en_op_map_response` ON `DM_DEVICE_OPERATION_RESPONSE`(`EN_OP_MAP_ID` ASC);
...
CREATE INDEX IF NOT EXISTS  `fk_DM_GROUP_USER_MAP_1_idx` ON `DM_GROUP_USER_MAP`(`GROUP_ID` ASC);