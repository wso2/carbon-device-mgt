...
/**
 * Initial operations that must be pushed to a device when enrolling.
 */
@ApiModel(description = "Initial operations that must be pushed to a device when enrolling.")
