...
public interface DeviceDAO {
    ...
    //Method by Zapcom
    boolean clearLogs(int enrolmentId) throws DeviceManagementDAOException;
    /**
    ...
    List<String> getGroupsOfDevice(DeviceIdentifier deviceIdentifier) throws DeviceManagementDAOException;
