...
app.server = function(ctx) {
    return {
        ...
        configs:{
            ...
            disabledAssets:['ebook', 'api', 'wsdl', 'service','policy','proxy','schema','sequence','servicex','uri','wadl','endpoint','swagger','restservice','comments','soapservice', 'license', 'gadget', 'site']
        }
    }
};
