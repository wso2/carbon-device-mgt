...
public class EnrolmentInfo   {
  ...
  **/
   ...
   * @return owner
  **/
  @ApiModelProperty(value = "The device owner's name.")
  ...
  **/
  @ApiModelProperty(value = "Date of the device enrollment. This value is not necessary.")
  ...
  **/
  @ApiModelProperty(value = "Date of the device's last update. This value is not necessary.")
