...
@Component(
    name = "org.wso2.carbon.device.mgt.api.AdminApi",
...
public class AdminApi implements Microservice  {
   private final AdminApiService delegate = AdminApiServiceFactory.getAdminApi();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Getting the Supported Device Type with Meta Definition", notes = "Get the list of device types supported by WSO2 IoT.", response = DeviceType.class, responseContainer = "List", tags={ "Device Type Management Administrative Service", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK.   Successfully fetched the list of supported device types.", response = DeviceType.class, responseContainer = "List"),
...
,@ApiParam(value = "The device type name such as ios, android, windows or fire-alarm.",required=true) @PathParam("name") String name
 ,@Context Request request)
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Add Multiple Device Types", notes = "Add the details of a device type to the server which is provide meta data of the device.", response = void.class, tags={ "Device Type Management Administrative Service", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK.   Successfully added the device type.", response = void.class),
        ...
        @io.swagger.annotations.ApiResponse(code = 500, message = "Internal Server Error.   Server error occurred while fetching the device list.", response = void.class) })
    public Response adminDeviceTypesPost(@ApiParam(value = "The device type such as iOS, Android, Windows or fire-alarm." ,required=true) List<DeviceType> type
 ,@Context Request request)
    throws NotFoundException {
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Update Multiple Device Types", notes = "Update the details of a device type in the server.", response = void.class, tags={ "Device Type Management Administrative Service", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK.   Successfully updated the device type.", response = void.class),
        ...
        @io.swagger.annotations.ApiResponse(code = 500, message = "Internal Server Error.   Server error occurred while fetching the device list.", response = void.class) })
    public Response adminDeviceTypesPut(@ApiParam(value = "The device type such as ios, android, windows or fire-alarm." ,required=true) List<DeviceType> type
 ,@Context Request request)
    throws NotFoundException {
