...
import org.wso2.carbon.device.mgt.extensions.jwt.client.dto.AccessTokenInfo;
...
public class JWTClient {
	...
	private static final String JWT_PARAM_NAME = "JWT";
	...
	public String generateSignedJWTAssertion(String username) throws JWTClientException {
		try {
			...
			throw new JWTClientException("No such algorithm found RS512.", e);
