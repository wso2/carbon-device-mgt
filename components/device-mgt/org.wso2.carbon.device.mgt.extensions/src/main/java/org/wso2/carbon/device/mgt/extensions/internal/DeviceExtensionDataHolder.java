...
public class DeviceExtensionDataHolder {
	private static DeviceExtensionDataHolder thisInstance = new DeviceExtensionDataHolder();
	...
	private DeviceExtensionDataHolder() {
	}


	public static DeviceExtensionDataHolder getInstance() {
		return thisInstance;
	}
