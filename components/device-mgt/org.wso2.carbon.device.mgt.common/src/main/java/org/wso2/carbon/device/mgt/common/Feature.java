...
//                                                   "such as android, iOS or windows..", required = true )
    ...
    /**
     * Inner class for MetadataEntry
     */
    public static class MetadataEntry implements Serializable {

        private static final long serialVersionUID = -8438754374341990410L;
