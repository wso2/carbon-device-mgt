...
package org.wso2.carbon.device.mgt.extensions.jwt.client;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.wso2.carbon.context.CarbonContext;
import org.wso2.carbon.context.PrivilegedCarbonContext;
import org.wso2.carbon.device.mgt.extensions.jwt.client.dto.JWTConfig;
import org.wso2.carbon.device.mgt.extensions.jwt.client.exception.JWTClientAlreadyExistsException;
import org.wso2.carbon.device.mgt.extensions.jwt.client.exception.JWTClientException;
import org.wso2.carbon.device.mgt.extensions.jwt.client.exception.JWTClientConfigurationException;
 ...
 */
public class JWTClientCreator {

	private static Map<String, JWTClient> jwtClientMap;
	private static JWTClientCreator jwtClientCreator;
	private static final Log log = LogFactory.getLog(JWTClientCreator.class);
	private static final String TENANT_JWT_CONFIG_LOCATION = "/jwt-config/jwt.properties";

	public static JWTClientCreator getInstance() {
		if (jwtClientCreator == null) {
			synchronized (JWTClientCreator.class) {
				if (jwtClientCreator == null) {
					jwtClientCreator = new JWTClientCreator();
				}
			}
		}
